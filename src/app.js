...
function getForecast(coordinates) {
  ...
  let apiUrl = `https://api.openweathermap.org/data/3.0/onecall?lat=${response.data.coordinates.latitude}&lon=${response.data.coordinates.longitude}&keyid={apiKey}&units=imperial`;
